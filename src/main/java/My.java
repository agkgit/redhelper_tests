...
public class My extends TestPage {
	...
	public static final By BY_NUMBER_IMPUT_PRODUCTION =	By.xpath("/html/body/div[3]/div[3]/div[3]/div[2]/div[3]/div[4]/div/div/div[2]/div[2]/ul[2]/li[1]/div[2]/div[1]/div[1]/div[1]/div/input[1]");
	public static final By BY_NUMBER_IMPUT_TESTING =	By.xpath("/html/body/div[3]/div[2]/div[3]/div[2]/div[3]/div[4]/div/div/div[2]/div[2]/ul[2]/li[1]/div[2]/div[1]/div[1]/div[1]/div/input[1]");
	BY_DELETE_PHONE
	...
	public void setOperator(RCOperator operator) {
		...
		WebElement numberInputElement = driver.findElement(BY_NUMBER_IMPUT_TESTING);
		if (this.rcEnvironment == rcEnvironment.PRODUCTION) {
			numberInputElement = driver.findElement(BY_NUMBER_IMPUT_PRODUCTION);
		}
